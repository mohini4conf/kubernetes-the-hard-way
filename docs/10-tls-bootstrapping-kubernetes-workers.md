...
```
sudo kubectl config --kubeconfig=/var/lib/kubelet/bootstrap-kubeconfig set-cluster bootstrap --server='https://10.0.2.9:6443' --certificate-authority=/var/lib/kubernetes/ca.crt
