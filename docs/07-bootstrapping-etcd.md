...
ExecStart=/usr/local/bin/etcd \\
  ...
  --initial-cluster master-1=https://10.0.2.4:2380,master-2=https://10.0.2.5:2380 \\
...
```
45bf9ccad8d8900a, started, master-2, https://10.0.2.5:2380, https://10.0.2.5:2379
54a5796a6803f252, started, master-1, https://10.0.2.4:2380, https://10.0.2.4:2379
```
